...
namespace HotelManager
{
    ...
    /* private void bunifuThinButton21_Click(object sender, EventArgs e)
       {
           DialogResult result = MessageBox.Show("Bạn có muốn xóa không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
           if (result == DialogResult.OK)
           {
               DeleteSurcharge();
               comboboxName.Focus();
    ...
    /*   private void DeleteSurcharge()
       {
               ...
               try
               {
                   Parameter surchargeNow = GetSurchargeNow();
                       ...
                       bool check = ParameterDAO.Instance.DeleteParameter(surchargeNow.Name);
                       if (check)
                       {
                           ...
                           MessageBox.Show("Không thể xóa (Không có phụ thu này)", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Stop);
