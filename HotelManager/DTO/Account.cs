...
namespace HotelManager.DTO
{
    public class Account
    {
        ...
        #region Constructor
        public Account() { }
        public Account(int id ,string userName, string displayName, string passWord, int staffType, string idCard, DateTime dateOfBirth, string sex, string address, string phoneNumber, DateTime startDay)
        {   this.ID = id; 
        ...
        public bool Equals(Account accountPre)
        {
            ...
            if (name != accountPre.name) return false;
