...
namespace HotelManager.DAO
{
    public class ServiceTypeDAO
    {
        ...
        public bool UseServiceForServiceType(int id)
        {
            string query = "USP_UseServiceForServiceType @id";
            return DataProvider.Instance.ExecuteQuery(query, new object[] { id }).Rows.Count>0;
        }
        public bool UseServiceinBillForServiceType(int id)
        {
            string query = "USP_UseServiceinBillForServiceType @id";
            return DataProvider.Instance.ExecuteQuery(query, new object[] { id }).Rows.Count > 0;
        }
