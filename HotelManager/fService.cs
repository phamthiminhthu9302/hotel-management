...
namespace HotelManager
{
    public partial class fService : Form
    {
                    ...
                    else
                    {
                        ...
                        if (check)
                        {
                            ...
                            LoadFullService(GetFullService());
                                ...
                                dataGridViewService.SelectedRows[0].Selected = false;
                                dataGridViewService.Rows[index].Selected = true;
        ...
        private void btnDeleteServiceClick(object sender, EventArgs e)
        {
        ...
        private void DeleteService()
        {
                    ...
                    Service serviceNow = GetServiceNow();
            if (ServiceDAO.Instance.IsIDServiceExist(serviceNow.Id.ToString()))
            {
            ...
            else
            {
                ...
                bool check = ServiceDAO.Instance.DeleteService(serviceNow.Id);
                if (check)
                {
                    ...
                    MessageBox.Show("Xóa thông tin dịch vụ thất bại!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
